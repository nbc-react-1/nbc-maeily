...
function MyPosts() {
  ...
  // };
  console.log('updatePhoto 전체 reload 중...?', updatePhoto);
  console.log('isOpen 전체 reload 중...?', isOpen);
  const { profileImg, nickname } = storeInfo;

  useEffect(() => {
    console.log(updatePhoto, 'updatePhoto111111');
    console.log(isOpen, 'isOpen1111111');
